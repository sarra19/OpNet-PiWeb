...
<tbody>
  ...
  color="info"
  style={buttonStyles}
  disabled={!offer.quiz} // Disable button if offer.quiz is false
>
  {offer.quiz ? ( // Render link only if offer.quiz is true
    <Link
      to={`/quiz?offerId=${offer._id}`}
      style={{ textDecoration: "none", color: "white" }}
    >
      Quiz
    </Link>
  ) : (
    "Quiz" // Render button text without link if offer.quiz is false
  )}
</MDButton>
